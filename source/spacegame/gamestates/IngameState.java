...
public class IngameState extends BasicGameState {
	...
	//holds most of the logic for the game
	...
	public void init(GameContainer container, StateBasedGame game) throws SlickException {
		...
		//guiHierarchy.openGuiOnKeyPress(new GuiCmdOverlay(), GameConstants.COMMAND); removed for release
	...
	public void render(GameContainer container, StateBasedGame game, Graphics g) throws SlickException {
		...
		renderer.render(container, g); //draws most of the game
		if(guiHierarchy.currentGui != null) {
			guiHierarchy.currentGui.render(g, container); //draws the currently opened screen, typically the hud
		}
	}
	...
	public void update(GameContainer container, StateBasedGame game, int delta) throws SlickException {
		gContainer = container;
		//update the logic of the entities if the game is not paused
		if(!gamePaused) {
			...
			//background music, permanent loop
		...
		//updates the keyboard listener for keyboard events
