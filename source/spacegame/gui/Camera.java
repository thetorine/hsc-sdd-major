...
//a camera that focuses on a particular rectangle in the game map
public class Camera {
	...
	//ensures that the rectangle moves properly with the locked entity
	...
	//changes the currently focused entity.
