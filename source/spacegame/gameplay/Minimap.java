...
public class Minimap {
	...
	//designations are the size and colours of the blips on the minimap
	public Minimap() {
	...
	public void render(Graphics g, float width, float height, EntityPlayer player) {
		...
		//radian magic for n s e w compass points
		...
		//players direction is always straight, nsew move respective to it
		str = "P";
		g.setColor(Color.cyan);
		g.drawString(str, (float) (cX - 0.5*g.getFont().getWidth(str)), (float) (cY - (mapRadius*1.1) - 0.5*g.getFont().getHeight(str)));

		//draws the entities that are within a certain range
	...
	//class to hold sizes and colours for a specific entity
