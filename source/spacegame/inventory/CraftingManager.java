...
public class CraftingManager {
	...
	public CraftingManager() {
		...
		addRecipe(new ItemStack(Item.blaster, 1), new ItemStack(Item.metal, 3));
		addRecipe(new ItemStack(Item.missile, 1), new ItemStack(Item.metal, 3), new ItemStack(Item.energy_casket, 1), new ItemStack(Item.ionic_diode, 1));
	}
